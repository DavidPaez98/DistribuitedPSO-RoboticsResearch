...
Number_Robots = 1 #Numero de Robots
...
C = [0.1,0.5,2,1.5,0.5] # Coeficientes PSO   #  0=velocdad  1=particula   2=swarm   3=repulsion part   4= repulsion swarm
dt = 0.1#0.2 # Paso o Step en la actualizacion PSO

Dist_Enjambre = 3 # 3  Distancia Minima - Desviacion estandar
Dist_Particula = 1 #0.7   Distancia Minima - Desviacion estandar   
...
x_max=y_max = 50 
epocas = 10000 # Numero de Iteraciones
...
for Robot in range(Number_Robots): #Declaracion de las particulas con posicion[x,y,z] y velocidad [x,y,z]
    for particula_ in range(Part_Enjambre): 
        posicion = np.random.randint(-10,10, size = 2) # Valores entre -5 y 5 de un arreglo de dos dimensiones
...
pickle.dump([X,Y,Z,HistPosPar,HistPosTarget,epocas,Number_Robots,Part_Enjambre], open("Caso1.p", "wb"))
