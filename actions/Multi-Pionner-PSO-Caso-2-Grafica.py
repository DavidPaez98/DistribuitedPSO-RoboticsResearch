...
for Robot in range(Number_Robots):
    ...
    ax.plot(HistPosTarget[Robot,:epocas-1000,0],HistPosTarget[Robot,:epocas-1000,1],zorder=25,c='#2737AE')
    ...
    for Pos_Med in range(epocas):
        #print(Pos_Med)
        if Pos_Med % 600 == 0:            
            ax.scatter(HistPosTarget[Robot,Pos_Med,0],HistPosTarget[Robot,Pos_Med,1], s=0, c='c', marker='o', zorder=100)
        
ax.scatter(HistPosTarget[:,epocas-1000,0],HistPosTarget[:,epocas-1000,1], s=80, c='m', marker='o',zorder=200, label="Robot Final Position")       
ax.scatter(HistPosTarget[:,0,0],HistPosTarget[:,0,1], s=80, c='c', marker='o',zorder=200, label="Robot Final Position")       
ax.scatter(HistPosTarget[:,epocas-4500,0],HistPosTarget[:,epocas-4500,1], s=120, c='g', marker='o',zorder=200, label="Robot Intermediate Position")       
ax.legend()       
ax.grid()
