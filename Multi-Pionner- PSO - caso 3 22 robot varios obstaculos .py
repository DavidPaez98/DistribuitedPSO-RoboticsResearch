...
def funEval3D(posicion):
    ...
    Z_Global_ = makeGaussian(xRobot,yRobot,-2,0,45,200,40,0.5)
...
Number_Robots = 22 #Numero de Robots
...
C = [0.1,0.3,1.5,0.5,2.5] # Coeficientes PSO   #  0=velocdad  1=particula   2=swarm   3=repulsion part   4= repulsion swarm
...
Std_Victim = 20   # 10 Grosor de la Gaussiana en la construccion de la Superficie - Victimas
